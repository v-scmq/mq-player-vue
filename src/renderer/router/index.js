...
export default new VueRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        {path: 'singer-list', component: () => import('../views/SingerList'), meta: {title: '歌手'}},
        {path: 'special-list', component: () => import('../views/SpecialList'), meta: {title: '歌单'}},
        {path: 'mv-list', component: () => import('../views/MVList'), meta: {title: 'MV'}},
        {path: 'rank-list', component: () => import('../views/RankList'), meta: {title: '排行榜'}},
