import type { Cookie, IpcRendererEvent } from 'electron';
 ...
 * 窗口状态监听器
 */
export type WindowStateListener = (event: IpcRendererEvent, isMaximize: boolean) => void;
...
export interface DataSource {
   ...
   */
  login(cookies: Cookie[] | null): Promise<LoginModuleData>;
