  ...
  setup() {
    ...
    $player.setEventListener({
      ...
      statusChanged(status) {
        ...
        statusIcon.value = status === $player.$statusType.PLAYING ? PAUSE_ICON : PLAY_ICON;
      },
